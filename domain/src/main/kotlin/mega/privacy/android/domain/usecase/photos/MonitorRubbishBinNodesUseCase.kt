...
/**
 * Use case to monitor rubbish bin image nodes
 */
class MonitorRubbishBinNodesUseCase @Inject constructor(
    ...
    private suspend fun populateNodes(parentId: NodeId): List<ImageNode> {
        ...
        val nodes = photosRepository.fetchImageNodes(parentId, sortOrder, includeRubbishBin = true)
