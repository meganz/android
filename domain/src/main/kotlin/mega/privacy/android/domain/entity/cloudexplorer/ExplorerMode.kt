...
enum class ExplorerMode(
    ...
    ShareFilesToMega(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = true),

    /** Upload text shared from an external app to a MEGA folder. */
    ShareTextToMega(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = true),

    /** Upload a URL shared from an external app to a MEGA folder. */
    ShareURLToMega(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = true),

    /** Save a scanned document to a MEGA folder. */
    SaveScannedDocument(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = true),

    /** Select files to send to a chat conversation. */
    ShareFilesToChat(isFolderPicker = false, isIncomingAvailable = true, isChatAvailable = false),

    /** Select a destination folder to move nodes into. */
    Move(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = false),

    /** Select a destination folder to copy nodes into. */
    Copy(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = false),

    /** Select a folder for Camera Uploads. */
    SelectCUFolder(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = false),

    /** Select a destination folder to import nodes from a public link. */
    Import(isFolderPicker = true, isIncomingAvailable = true, isChatAvailable = false),

    /** Select a destination folder to import an album. */
    AlbumImport(isFolderPicker = true, isIncomingAvailable = false, isChatAvailable = false),
