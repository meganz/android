 ...
 *
 * @property cameraUploadRepository Repository containing all Camera Uploads related operations
...
class GetPrimaryFolderNodeUseCase @Inject constructor(
    ...
    suspend operator fun invoke(nodeId: NodeId? = null): TypedNode? {
        ...
        val invalidHandle = NodeId(cameraUploadRepository.getInvalidHandle())
