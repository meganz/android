...
class GetChatFileUseCase @Inject constructor(
     ...
     */
    suspend operator fun invoke(chatId: Long, messageId: Long, messageIndex: Int = 0) =
        nodeRepository.getNodeFromChatMessage(chatId, messageId, messageIndex)?.let {
            addChatFileTypeUseCase(it, chatId, messageId, messageIndex)
        }
}