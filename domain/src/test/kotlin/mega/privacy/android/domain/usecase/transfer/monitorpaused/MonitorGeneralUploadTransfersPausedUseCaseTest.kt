...
class MonitorGeneralUploadTransfersPausedUseCaseTest {
    private lateinit var underTest: MonitorGeneralUploadTransfersPausedUseCase

    private val transferRepository = mock<TransferRepository>()

    @BeforeAll
    fun setup() {
        underTest = MonitorGeneralUploadTransfersPausedUseCase(transferRepository)
    }
