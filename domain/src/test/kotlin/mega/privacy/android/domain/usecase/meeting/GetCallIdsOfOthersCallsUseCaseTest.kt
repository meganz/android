...
class GetCallIdsOfOthersCallsUseCaseTest {
    private lateinit var underTest: GetCallIdsOfOthersCallsUseCase
    ...
    @BeforeEach
    internal fun setUp() {
        underTest = GetCallIdsOfOthersCallsUseCase(callRepository = callRepository)
    }
