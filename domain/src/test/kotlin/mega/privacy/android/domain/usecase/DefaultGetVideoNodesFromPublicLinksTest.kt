...
class DefaultGetVideoNodesFromPublicLinksTest {
    lateinit var underTest: GetVideoNodesFromPublicLinks
    ...
    @Before
    fun setUp() {
        underTest = DefaultGetVideoNodesFromPublicLinks(mediaPlayerRepository, addNodeType)
    }
    ...
    fun `test that the AddNodeType has been invoked`() =
        runTest {
            ...
            whenever(mediaPlayerRepository.getVideoNodesFromPublicLinks(sortOrder)).thenReturn(
                unTypedNodeList)
