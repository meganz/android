...
class RemoveChatLinkUseCaseTest {

    private lateinit var underTest: RemoveChatLinkUseCase
    ...
    @BeforeEach
    fun setUp() {
        underTest = RemoveChatLinkUseCase(
    ...
    fun `test that the correct chat request is returned`() = runTest {
        ...
        whenever(chatRepository.removeChatLink(chatId = chatId)) doReturn charRequest
