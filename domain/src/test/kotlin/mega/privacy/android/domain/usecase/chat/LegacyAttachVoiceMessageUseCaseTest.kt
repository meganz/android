...
class LegacyAttachVoiceMessageUseCaseTest {

    private val chatRepository = mock<ChatRepository>()

    private lateinit var underTest: LegacyAttachVoiceMessageUseCase

    @BeforeEach
    fun setup() {
        underTest = LegacyAttachVoiceMessageUseCase(chatRepository)
    }
