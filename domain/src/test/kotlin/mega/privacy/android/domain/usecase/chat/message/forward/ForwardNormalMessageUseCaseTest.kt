...
class ForwardNormalMessageUseCaseTest {

    private lateinit var underTest: ForwardNormalMessageUseCase
    ...
    @BeforeEach
    fun setup() {
        underTest = ForwardNormalMessageUseCase(sendTextMessageUseCase = sendTextMessageUseCase)
    }
