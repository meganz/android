...
class DefaultGetAudioNodesFromPublicLinksTest {
    lateinit var underTest: GetAudioNodesFromPublicLinks
    ...
    @Before
    fun setUp() {
        underTest = DefaultGetAudioNodesFromPublicLinks(mediaPlayerRepository, addNodeType)
    }
