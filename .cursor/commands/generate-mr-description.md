...
- **Default**: Generate MR description based on diff between current branch and develop
- `--output <path>`: Save the report to a file (e.g. `--output ./review.md`)
...
### Step 3 — Write the description in this exact format
...
### Step 4 — Save to file (if `--output <path>` was passed)
