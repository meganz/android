...
class AppleInstructionsViewTest {
    ...
    fun `test that all apple instructions views are showing`() {
        ...
        composeTestRule.onNodeWithText(fromId(R.string.account_cancellation_instructions_ios_device))
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(fromId(R.string.account_cancellation_instructions_open_settings))
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(fromId(R.string.account_cancellation_instructions_tap_on_name))
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(fromId(R.string.account_cancellation_instructions_select_subscriptions))
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(fromId(R.string.account_cancellation_instructions_select_mega_subscription))
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(fromId(R.string.account_cancellation_instructions_open_select_cancel_subscription))
            .assertIsDisplayed()
