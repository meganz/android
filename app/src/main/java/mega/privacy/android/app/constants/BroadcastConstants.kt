...
object BroadcastConstants {
    ...
    const val ACTION_UPDATE_CU_DESTINATION_FOLDER_SETTING =
    ...
    const val ACTION_UPDATE_FILE_VERSIONS = "ACTION_UPDATE_FILE_VERSIONS"
    ...
    const val DOWNLOAD_MS_FILE_AND_OPEN = "DOWNLOAD_MS_FILE_AND_OPEN"
    const val UPLOAD_TRANSFER = "UPLOAD_TRANSFER"
    const val EXTRA_IS_CU_SECONDARY_FOLDER = "EXTRA_IS_CU_SECONDARY_FOLDER"
    const val UPDATE_PROXIMITY_SENSOR_STATUS = "UPDATE_PROXIMITY_SENSOR_STATUS"
    const val EXTRA_BROADCAST_INVALID_VALUE = -1
    ...
    const val SECONDARY_FOLDER = "SECONDARY_FOLDER"
    const val PRIMARY_HANDLE = "PRIMARY_HANDLE"
