 ...
 * @property AuthenticationScreen the third screen where the user input the authentication code to enable the 2FA
 * @property AuthenticationCompletedScreen the last screen that shows successful authentication to the user
 */
