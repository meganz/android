 ...
 */
class LegacyFabButtonAdd @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : LegacyFabButton(context, attrs, defStyleAttr) {
    override val iconImageVector: ImageVector = IconPack.Medium.Thin.Outline.Plus
    override val iconResource: Int get() = R.drawable.ic_add_white
}