...
public class PendingNodeAttachment {
    ...
    public PendingNodeAttachment(String filePath, String fingerprints, String name) {
    ...
    public PendingNodeAttachment(String filePath, String fingerprints, String name, long nodeHandle) {
        this.filePath = filePath;
        this.fingerprint = fingerprints;
        this.name = name;
