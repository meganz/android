...
public class ContactFileListBottomSheetDialogFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null) {
            ...
            log("Bundle NULL");
            if(context instanceof ContactPropertiesActivityLollipop){
                node = ((ContactPropertiesActivityLollipop) context).getSelectedNode();
            }
        }
    ...
    public void setupDialog(final Dialog dialog, int style) {
        ...
        if(node!=null) {
            ...
            boolean firstLevel = ((ContactPropertiesActivityLollipop) context).isEmptyParentHandleStack();
            log("First LEVEL is: "+firstLevel);
            long parentHandle = -1;
            parentHandle = ((ContactPropertiesActivityLollipop) context).getParentHandle();
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.option_leave_layout:{
                ...
                ((ContactPropertiesActivityLollipop) context).showConfirmationLeaveIncomingShare(node);
                dismissAllowingStateLoss();
                break;
            }
            case R.id.option_rename_layout:{
                ...
                ((ContactPropertiesActivityLollipop) context).showRenameDialog(node, node.getName());
                break;
            }
