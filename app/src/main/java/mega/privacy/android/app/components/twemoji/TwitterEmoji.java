...
public class TwitterEmoji extends Emoji {
  ...
  public TwitterEmoji(@NonNull  int[] codePoints, int x, int y) {
    super(codePoints, -1);
    this.x = x;
    this.y = y;
  }

  public TwitterEmoji(int codePoint, int x, int y) {
    super(codePoint, -1);
    this.x = x;
    this.y = y;
  }

  public TwitterEmoji( int codePoint,int x, int y, Emoji... variants) {
    super(codePoint, -1, variants);
    this.x = x;
    this.y = y;
  }

  public TwitterEmoji(@NonNull int[] codePoints, int x, int y, Emoji... variants) {
