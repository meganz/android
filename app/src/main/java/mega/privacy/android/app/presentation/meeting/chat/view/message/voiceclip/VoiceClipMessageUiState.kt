 ...
 * @property proximitySensorState   [ProximitySensorState]
 * @property isPaused               True, if the voice clip is paused. False, if not.
 */
data class VoiceClipMessageUiState(
    ...
    val proximitySensorState: ProximitySensorState = ProximitySensorState.Unknown,
