...
@Composable
internal fun ManageChatHistory(isChatRoomExists: Boolean) =
    AnimatedVisibility(
...
@Composable
private fun PreviewManageChatHistoryLight() {
    AndroidTheme(isDark = false) {
        Surface {
            ManageChatHistory(isChatRoomExists = false)
        }
    }
}
...
@CombinedThemePreviews
@Composable
private fun PreviewManageChatHistoryDark() {
    AndroidTheme(isDark = true) {
        Surface {
            ManageChatHistory(isChatRoomExists = true)
        }
    }
}