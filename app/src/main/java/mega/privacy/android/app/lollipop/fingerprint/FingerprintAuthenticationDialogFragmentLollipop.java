...
public class FingerprintAuthenticationDialogFragmentLollipop extends DialogFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFingerprintUiHelper = new FingerprintUIHelper(getContext().getSystemService(FingerprintManager.class),
    ...
    public void onAuthenticated() {
        ...
        // successful.
        mFingerprintUiHelper.stopListening();
        ((FingerprintAuthenticationListener) getActivity()).onSuccessFingerprintAuthentication();
    }
    ...
    public interface FingerprintAuthenticationListener {
        ...
        void onSuccessFingerprintAuthentication();
