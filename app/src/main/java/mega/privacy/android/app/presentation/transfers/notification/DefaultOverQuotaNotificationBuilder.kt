...
class DefaultOverQuotaNotificationBuilder @Inject constructor(
    ...
    private suspend fun transferOverQuotaNotification(): Notification {
        ...
        val actionPendingIntent = if (isLoggedIn) {
            ...
            megaNavigator.getPendingIntentConsideringSingleActivityWithDestination<LoginActivity, LoginNavKey>(
                context = context,
                createPendingIntent = { intent ->
    ...
    private fun Intent.createPendingIntent() = PendingIntent.getActivity(
        context,
        0,
        this,
