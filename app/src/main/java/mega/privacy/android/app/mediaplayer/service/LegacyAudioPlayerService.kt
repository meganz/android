 ...
 */
@AndroidEntryPoint
class LegacyAudioPlayerService : LifecycleService(), LifecycleEventObserver, MediaPlayerServiceGateway {
    /**
    ...
    override fun onCreate() {
        ...
        runCatching {
            ...
            Timber.e(e, "LegacyAudioPlayerService failed to initialise — stopping self")
            isRunning = false
            stopSelf()
        }
    }
    ...
    override fun onStateChanged(source: LifecycleOwner, event: Lifecycle.Event) {
        ...
        Timber.d("LegacyAudioPlayerService isForeground: $isForeground")
    }
    ...
    companion object {
        ...
        /**
         * Whether an instance of [LegacyAudioPlayerService] is currently running.
         ...
         * Only sends if [LegacyAudioPlayerService] is already started to avoid
        ...
        private fun sendCommandToAudioPlayer(context: Context, command: Int) {
            ...
            am.getRunningServices(Int.MAX_VALUE).firstOrNull { runningServiceInfo ->
                runningServiceInfo.service.className == LegacyAudioPlayerService::class.java.name
                ...
                if (runningServiceInfo.started) {
                    ...
                    val audioPlayerIntent = Intent(context, LegacyAudioPlayerService::class.java)
