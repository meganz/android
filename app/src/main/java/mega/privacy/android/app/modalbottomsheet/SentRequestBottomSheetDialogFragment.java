...
public class SentRequestBottomSheetDialogFragment extends BaseBottomSheetDialogFragment implements View.OnClickListener {

    private MegaContactRequest request = null;
    ...
    public void setupDialog(final Dialog dialog, int style) {
        ...
        contentView = View.inflate(getContext(), R.layout.bottom_sheet_sent_request, null);
        mainLinearLayout = contentView.findViewById(R.id.sent_request_item_bottom_sheet);
        items_layout = contentView.findViewById(R.id.items_layout);

        TextView titleNameContactChatPanel = contentView.findViewById(R.id.sent_request_list_contact_name_text);
        TextView titleMailContactChatPanel = contentView.findViewById(R.id.sent_request_list_contact_mail_text);
        RoundedImageView contactImageView = contentView.findViewById(R.id.sliding_sent_request_list_thumbnail);
        ...
        contentView.findViewById(R.id.contact_list_option_reinvite_layout).setOnClickListener(this);
        contentView.findViewById(R.id.contact_list_option_delete_request_layout).setOnClickListener(this);
