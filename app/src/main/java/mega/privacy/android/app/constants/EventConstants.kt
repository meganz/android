...
object EventConstants {
    ...
    const val EVENT_VAULT_ACTION = "EVENT_VAULT_ACTION"
    ...
    const val EVENT_TRANSFER_UPDATE = "EVENT_TRANSFER_UPDATE"
    const val EVENT_TRANSFER_OVER_QUOTA = "EVENT_TRANSFER_OVER_QUOTA"
    const val EVENT_FAILED_TRANSFERS = "EVENT_FAILED_TRANSFERS"
}