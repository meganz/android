 ...
 * @property contactItemList     List of [ContactItemUiState] rows to render.
 ...
 * @property filteredContactList Filtered list of [ContactItemUiState] based on [typedSearch].
...
data class StartConversationState(
    ...
    val contactItemList: List<ContactItemUiState> = emptyList(),
    ...
    val filteredContactList: List<ContactItemUiState>? = null,
