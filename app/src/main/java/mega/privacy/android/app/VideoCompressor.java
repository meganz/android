...
public class VideoCompressor {
    ...
    private static class ChangerWrapper implements Runnable {
        ...
        private VideoCompressor mChanger;

        private ChangerWrapper(VideoCompressor changer) {
            mChanger = changer;
        }
        ...
        public static void changeResolutionInSeparatedThread(VideoCompressor changer) throws Throwable {
    ...
    private void changeResolution(MediaExtractor videoExtractor,MediaExtractor audioExtractor,
        ...
        while ((!videoEncoderDone) || (!audioEncoderDone)) {
            while (!videoExtractorDone && (encoderOutputVideoFormat == null || muxing)) {
                ...
                video.sizeRead += size;
                TL.log(this,"video.sizeRead: " + video.sizeRead);
                if (size >= 0) {
            ...
            TL.log(this,"percentage: " + video.percentage);
        }
