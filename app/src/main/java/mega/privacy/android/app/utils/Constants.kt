...
object Constants {
    ...
    const val ACTION_SHORTCUT_CHAT: String = "mega.privacy.android.action.SHORTCUT_CHAT"
    ...
    const val ACTION_SHOW_CU_PROGRESS_VIEW: String = "ACTION_SHOW_CU_PROGRESS_VIEW"
    ...
    val ADAPTER_TYPES_WITHOUT_ACCESS_CHECK = setOf(OFFLINE_ADAPTER, ZIP_ADAPTER, FILE_LINK_ADAPTER)
    ...
    const val NOTIFICATION_FOLDER_CONFLICT_WITH_SYNC_OR_BACKUP: Int = 22
