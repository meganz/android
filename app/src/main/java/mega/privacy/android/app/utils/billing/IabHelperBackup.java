...
public class IabHelperBackup {
    ...
    private static final int IABHELPER_ILLEGAL_STATE_EXCEPTION = -1011;
     ...
     */
    public IabHelperBackup(Context ctx, String base64PublicKey) {
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode,
        ...
        try {
            ...
            logError("IllegalStateException while launching purchase flow for sku " + sku);
            e.printStackTrace();
            flagEndAsync();

            result = new IabResult(IABHELPER_ILLEGAL_STATE_EXCEPTION, "IllegalStateException while starting purchase flow");
            if (listener != null) {
        ...
        try {
            ...
            if (act == null) {
                Log.d("AndroidLogger", "ACT ES NULL!!!!!");
            }
