...
//
    ...
    private void insertPlaceHolderNode() {
        int folderCount = 0;
        ...
        MegaNode placeHolder = new MegaNode();
        placeHolder.setPrivateAuth("placeholder");
        if (folderCount > 0 && folderCount % 2 == 1) {
            nodes.add(folderCount,placeHolder);
        }
    }
...
//				thumb = ThumbnailUtils.getThumbnailFromCache(node);
        ...
        } else if(!node.isFolder() && !node.isFile()) {
