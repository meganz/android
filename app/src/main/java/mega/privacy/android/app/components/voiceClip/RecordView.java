    ...
    private void init(Context context) {
        ...
        cancelRecordLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Timber.d("cancelRecordLayout:onClick -> hideViews");
                hideViews();
            }
        });
