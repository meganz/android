...
class HomePageViewModel(
  ...
  private fun loadAvatar() {
    add(Single.just(true)
        ...
        .map {
          ...
          c.drawCircle(bitmap.width / 2F, bitmap.height / 2F, radius.toFloat(), paint)
        ...
        .subscribe({
          ...
          logError("loadAvatar onError", it)
        })
    )
  }
  ...
  private fun createAvatar() {
    megaApi.getUserAvatar(
        megaApi.myUser, buildAvatarFile(getApplication(), megaApi.myEmail + ".jpg").absolutePath,
