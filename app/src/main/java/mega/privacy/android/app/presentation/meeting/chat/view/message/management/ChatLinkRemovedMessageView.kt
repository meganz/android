 ...
 */
@Composable
fun ChatLinkRemovedView(
    message: ChatLinkRemovedMessage,
 ...
 */
@Composable
internal fun ChatLinkRemovedView(
    ownerActionFullName: String,
    modifier: Modifier = Modifier,
) = ChatManagementMessageView(
    text = stringResource(id = R.string.message_deleted_chat_link, ownerActionFullName),
    modifier = modifier,
    styles = mapOf(
