...
import static mega.privacy.android.app.utils.VideoCaptureUtils.isVideoAllowed;

public class MeetingVideoListener implements MegaChatVideoListenerInterface {
    ...
    public MeetingVideoListener(Context context, SurfaceView video, DisplayMetrics outMetrics, boolean isSmallCamera) {
        this.width = 0;
        this.height = 0;
