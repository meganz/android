...
import static mega.privacy.android.app.utils.Constants.EXTRA_USER_NICKNAME;
...
public class ContactNicknameBottomSheetDialogFragment extends BaseBottomSheetDialogFragment implements View.OnClickListener {
    ...
    private LegacyContactInfoViewModel viewModel;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        contentView = View.inflate(getContext(), R.layout.bottom_sheet_nickname, null);
        itemsLayout = contentView.findViewById(R.id.items_layout);
        viewModel = new ViewModelProvider(requireActivity()).get(LegacyContactInfoViewModel.class);
