 ...
 */
class CopyNodeListByHandleUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        for (nodeHandle in nodes) {
            runCatching {
                val node = megaApi.getMegaNodeByHandle(nodeHandle)
                    ?: throw IllegalArgumentException("No node found for handle $nodeHandle")
