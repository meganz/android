...
LOCAL_SRC_FILES := karereDbSchema.cpp $(addprefix karere-native/src/, megachatapi.cpp megachatapi_impl.cpp strongvelope/strongvelope.cpp presenced.cpp base64.cpp chatClient.cpp chatd.cpp url.cpp dummyCrypto.cpp karereCommon.cpp megaCryptoFunctions.cpp strophe.disco.cpp userAttrCache.cpp base/cservices.cpp base/cservices-dns.cpp base/cservices-http.cpp base/cservices-strophe.cpp base/logger.cpp base/services-dns.cpp rtcModule/lib.cpp rtcModule/rtcModule.cpp rtcModule/rtcStats.cpp rtcModule/strophe.jingle.cpp rtcModule/strophe.jingle.sdp.cpp rtcModule/strophe.jingle.session.cpp rtcModule/webrtcAdapter.cpp)
    
LOCAL_C_INCLUDES += $(local_c_includes)
LOCAL_EXPORT_C_INCLUDES += $(local_c_includes)
LOCAL_STATIC_LIBRARIES := curl cryptopp strophe libws megasdk
include $(BUILD_STATIC_LIBRARY)
