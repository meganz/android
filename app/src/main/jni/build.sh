...
function createMEGAchatBindings
{
    ...
    echo "//This file is autogenerated from src/dbSchema.sql" > megachat/karereDbSchema.cpp
    echo "namespace karere" >> megachat/karereDbSchema.cpp
    echo "{" >> megachat/karereDbSchema.cpp
    echo "    const char* gKarereDbSchema =" >> megachat/karereDbSchema.cpp
    sed -e 's/^.\{1,\}$/"&"/' megachat/karere-native/src/dbSchema.sql >> megachat/karereDbSchema.cpp
    echo ";}" >> megachat/karereDbSchema.cpp
}
