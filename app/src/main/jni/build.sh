...
function createMEGABindings
{
    ...
    mkdir -p ../../main/java/nz/mega/sdk
    swig -c++ -Imega/sdk/include -java -package nz.mega.sdk -outdir ${JAVA_OUTPUT_PATH}/nz/mega/sdk -o bindings/megasdk.cpp -DHAVE_LIBUV -D ENABLE_CHAT mega/sdk/bindings/megaapi.i &> ${LOG_FILE}
}

function createMEGAchatBindings
{
    echo "* Creating MEGAchat Java bindings"
    mkdir -p ../../main/java/nz/mega/chat/
    swig -c++ -Imegachat/karere-native/src/ -java -package nz.mega.chat -outdir ${JAVA_OUTPUT_PATH}/nz/mega/chat/ -o bindings/megachat.cpp megachat/megachatapi.i &> ${LOG_FILE}
