...
class IsUrlMatchesRegexUseCaseTest {
    ...
    private fun acceptedUrl(): Stream<Arguments> = Stream.of(
        ...
        Arguments.of("https://mega.app/home"),
        ...
        Arguments.of("https://mega.app/#testing"),
        Arguments.of("https://support.mega.nz/"),
        Arguments.of("https://support.mega.app/"),
        ...
        Arguments.of("https://help.mega.app/chat"),
        Arguments.of("https://help.mega.nz/chat?sort=DESC"),
        Arguments.of("https://help.mega.app/chat?sort=DESC"),
