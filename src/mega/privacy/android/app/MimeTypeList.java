...
public class MimeTypeList {
	...
	static {
		...
		resources.put(R.drawable.ic_after_effects_list, new String[] {"aec", "aep", "aepx", "aes", "aet", "aetx", });
		...
		resources.put(R.drawable.ic_excell_list, new String[] {"xls", "xlsx", "xlt", "xltm", "xltx", });
		resources.put(R.drawable.ic_exe_list, new String[] {"apk", "app", "bat", "com", "exe", "gadget", "msi", "pif", "vb", "wsf", });
		resources.put(R.drawable.ic_fla_lang_list, new String[] {"as", "asc", "ascs", });
		...
		resources.put(R.drawable.ic_graphic_list, new String[] {"tga", "tif", "tiff", "bmp", "gif", "png", });
		...
		resources.put(R.drawable.ic_text_list, new String[] {"ans", "ascii", "log", "odt", "rtf", "txt", "wpd", });
