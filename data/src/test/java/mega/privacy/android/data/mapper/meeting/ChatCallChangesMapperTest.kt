...
class ChatCallChangesMapperTest {
    ...
    fun `test mapped correctly`() {
        ...
        Truth.assertThat(underTest(MegaChatCall.CHANGE_TYPE_OWN_PERMISSIONS))
            .contains(ChatCallChanges.OwnPermissions)
        Truth.assertThat(underTest(MegaChatCall.CHANGE_TYPE_GENERIC_NOTIFICATION))
            .contains(ChatCallChanges.GenericNotification)
        ...
        Truth.assertThat(underTest(MegaChatCall.CHANGE_TYPE_SPEAK_REQUESTED))
