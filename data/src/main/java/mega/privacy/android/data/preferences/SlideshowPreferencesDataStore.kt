...
internal class SlideshowPreferencesDataStore @Inject constructor(
    ...
    companion object {
        ...
        private const val secureTutorialPreferenceKeyString = "SLIDESHOW_SECURE_TUTORIAL"
    }
    ...
    override fun monitorSecureSlideshowTutorialShown(): Flow<Boolean> =
        context.dataStore.data.map { prefs ->
            prefs[booleanPreferencesKey(secureTutorialPreferenceKeyString)] == true
        }

    override suspend fun setSecureSlideshowTutorialShown() {
        withContext(ioDispatcher) {
            context.dataStore.edit {
                it[booleanPreferencesKey(secureTutorialPreferenceKeyString)] = true
            }
        }
    }
}
