...
/**
 * Implementation of [ChatRequestMapper].
 */
internal class ChatRequestMapperImpl @Inject constructor() : ChatRequestMapper {

    override fun invoke(megaChatRequest: MegaChatRequest) = ChatRequest(
