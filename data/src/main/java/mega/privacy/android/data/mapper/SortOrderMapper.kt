...
/**
 * Mapper convert Sort Order related Integer values in MegaApiJava to [SortOrder]
 */
 ...
 */
internal fun toSortOrder(order: Int) = when (order) {
    ...
    MegaApiJava.ORDER_ALPHABETICAL_ASC -> SortOrder.ORDER_ALPHABETICAL_ASC
    MegaApiJava.ORDER_ALPHABETICAL_DESC -> SortOrder.ORDER_ALPHABETICAL_DESC
    MegaApiJava.ORDER_PHOTO_ASC -> SortOrder.ORDER_PHOTO_ASC
    MegaApiJava.ORDER_PHOTO_DESC -> SortOrder.ORDER_PHOTO_DESC
    MegaApiJava.ORDER_VIDEO_ASC -> SortOrder.ORDER_VIDEO_ASC
    MegaApiJava.ORDER_VIDEO_DESC -> SortOrder.ORDER_VIDEO_DESC
