...
class SortOrderIntMapper @Inject constructor() {
    ...
    operator fun invoke(
        ...
        SortOrder.ORDER_CREATION_ASC -> if (source.isOutgoingShares()) MegaApiJava.ORDER_SHARE_CREATION_ASC else MegaApiJava.ORDER_CREATION_ASC
        SortOrder.ORDER_CREATION_DESC -> if (source.isOutgoingShares()) MegaApiJava.ORDER_SHARE_CREATION_DESC else MegaApiJava.ORDER_CREATION_DESC
    ...
    private fun SortOrderSource.isOutgoingShares(): Boolean =
        this == SortOrderSource.OutgoingShares || this == SortOrderSource.OutgoingSharesSingleActivity
}
