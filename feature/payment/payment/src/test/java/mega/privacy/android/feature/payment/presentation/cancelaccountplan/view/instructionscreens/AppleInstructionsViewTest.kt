...
class AppleInstructionsViewTest {
    ...
    fun `test that all apple instructions views are showing`() {
        ...
        composeTestRule.onNodeWithText(R.string.account_cancellation_instructions_not_managed_by_google)
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(R.string.account_cancellation_instructions_message_apple_description)
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(R.string.account_cancellation_instructions_ios_device)
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(R.string.account_cancellation_instructions_tap_on_name)
            .assertIsDisplayed()
        composeTestRule.onNodeWithText(R.string.account_cancellation_instructions_select_mega_subscription)
            .assertIsDisplayed()
