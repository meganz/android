...
import mega.privacy.android.feature.payment.presentation.cancelaccountplan.CancelAccountPlanViewModel
...
internal class CancelAccountPlanViewModelTest {
    ...
    private val accountTypeNameResourceProvider = mock<SharedStringResourceProvider<AccountType?>>()
    ...
    private fun initViewModel() {
        underTest = CancelAccountPlanViewModel(
            ...
            accountTypeNameResourceProvider = accountTypeNameResourceProvider,
    ...
    fun setUp() {
        reset(
            ...
            formattedSizeMapper,
            accountTypeNameResourceProvider,
    ...
    fun `test that isMonthlySubscription return correct value`(
        ...
        runTest {
            ...
            whenever(accountTypeNameResourceProvider(any())).thenReturn(45)
