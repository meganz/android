...
import mega.privacy.android.feature.payment.presentation.cancelaccountplan.model.CancelAccountPlanUiState
import mega.privacy.android.feature.payment.presentation.cancelaccountplan.model.UICancellationSurveyAnswer
import mega.privacy.android.feature.payment.presentation.cancelaccountplan.model.mapper.CancellationInstructionsTypeMapper
 ...
 *
 * @param accountTypeNameResourceProvider provides string resource ID for account type name
 ...
 */
@HiltViewModel
internal class CancelAccountPlanViewModel @Inject constructor(
    private val accountTypeNameResourceProvider: SharedStringResourceProvider<AccountType?>,
                        ...
                        accountDetail.levelDetail?.accountType?.let { accountType ->
                            ...
                            _state.update {
                                it.copy(
                                    ...
                                    accountNameRes = accountTypeNameResourceProvider(accountType),
                                    isLoading = false,
