...
internal fun CancelAccountPlanView(
    ...
    Column(
        ...
        val cells = listOf(
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_feature),
                style = TableCell.TextCellStyle.Header,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_free_plan),
                style = TableCell.TextCellStyle.Header,
                cellAlignment = TableCell.CellAlignment.Center,
            ),
            TableCell.TextCell(
                text = stringResource(id = uiState.accountNameRes),
                style = TableCell.TextCellStyle.Header,
                cellAlignment = TableCell.CellAlignment.Center,
            ),

            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_storage),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.TextCell(
                text = formattedBaseStorage,
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_transfer),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_free_limited_transfer),
                style = TableCell.TextCellStyle.Normal,
                cellAlignment = TableCell.CellAlignment.Center,
            ),
            TableCell.TextCell(
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_password_protected_links),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_links_with_expiry_dates),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.IconCell(iconResId = drawable.ic_not_available),
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_transfer_sharing),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.IconCell(iconResId = drawable.ic_not_available),
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_rewind),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_rewind_free),
                style = TableCell.TextCellStyle.Normal,
                cellAlignment = TableCell.CellAlignment.Center,
            ),
            TableCell.TextCell(
                text = stringResource(
                    id = SharedR.string.account_cancel_account_screen_plan_rewind_current,
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_mega_vpn),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.IconCell(iconResId = drawable.ic_not_available),
            ...
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_call_meeting_duration),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_screen_plan_call_meeting_duration_free),
                style = TableCell.TextCellStyle.Normal,
                cellAlignment = TableCell.CellAlignment.Center,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.cancel_account_plan_call_meeting_duration_pro),
                style = TableCell.TextCellStyle.Normal,
                cellAlignment = TableCell.CellAlignment.Center,
            ),

            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_plan_call_meeting_participants),
                style = TableCell.TextCellStyle.SubHeader,
                cellAlignment = TableCell.CellAlignment.Start,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_free_plan_call_meeting_participants),
                style = TableCell.TextCellStyle.Normal,
                cellAlignment = TableCell.CellAlignment.Center,
            ),
            TableCell.TextCell(
                text = stringResource(id = SharedR.string.account_cancel_account_pro_plan_call_meeting_participants),
                style = TableCell.TextCellStyle.Normal,
                cellAlignment = TableCell.CellAlignment.Center,
            ),
        )
