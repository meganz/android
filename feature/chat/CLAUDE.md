...
> Module path: `:feature:chat` · Build file: `feature/chat/chat.gradle.kts` · Namespace: `mega.privacy.android.feature.settings`
...
## Notes & Gotchas
- The `namespace` is `mega.privacy.android.feature.settings` (inherited boilerplate), not `...feature.chat`. Be careful when referencing R / generated classes.
