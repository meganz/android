...
/**
 * UI state for selecting a destination folder to move nodes into.
 */
@Stable
sealed interface MoveUiState {
     ...
     * @property targetPath Folders to push onto the back stack (top-down) to resume at the last move
