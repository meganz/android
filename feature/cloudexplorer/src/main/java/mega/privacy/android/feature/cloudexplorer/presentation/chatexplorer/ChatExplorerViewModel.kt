...
internal class ChatExplorerViewModel @Inject constructor(
    ...
    val uiState: StateFlow<ChatExplorerUiState> by lazy(LazyThreadSafetyMode.NONE) {
        ...
        ) { data, newChatCreatedEvent ->
            data.copy(newChatCreatedEvent = newChatCreatedEvent)
        }
    ...
    private suspend fun ChatExplorerUiState.Data.applyChatUpdate(chat: ChatListItem): ChatExplorerUiState.Data {
    ...
    private fun ChatExplorerUiState.Data.removeUpdatedChat(chatId: Long): ChatExplorerUiState.Data =
        copy(
     ...
     */
    private fun ChatExplorerUiState.Data.insertActiveChat(chat: ChatExplorerUiItem): ChatExplorerUiState.Data {
     ...
     */
    private fun ChatExplorerUiState.Data.updateRecentsIfNeeded(): ChatExplorerUiState.Data {
