...
/**
 * Returns the list of actions to show in the text editor bottom floating bar.
 ...
 */
fun computeTextEditorBottomBarActions(
    mode: TextEditorMode,
    ...
    val showEdit = !inExcludedAdapterForGetLinkAndEdit
            && (accessPermission == AccessPermission.OWNER || accessPermission == AccessPermission.FULL || accessPermission == AccessPermission.READWRITE)
