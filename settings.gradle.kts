...
include(":core:passcode:passcode")
include(":core:passcode:passcode-snowflake-components")
...
include(":core:passcode")
include(":core:transfers")
include(":data")
include(":data-test")
include(":domain")
include(":feature:chat:chat")
include(":feature:chat:chat-snowflake-components")
...
include(":feature:text-editor:text-editor-snowflake-components")
include(":feature:document-scanner:document-scanner")
include(":feature:document-scanner:document-scanner-snowflake-components")
include(":feature:media-player:media-player")
include(":feature:media-player:media-player-snowflake-components")
include(":feature:transfers:transfers")
...
include(":feature:video-editor:video-editor")
include(":feature:video-editor:video-editor-snowflakes")
include(":feature:share-link")
