...
public fun createMediumRegularOutlineAlertCircleImageVector(): ImageVector = ImageVector.Builder(
    name = "icon_alert-circle_medium_regular_outline",
    ...
    path(
        ...
        lineTo(12.01f, 17.0f)
        curveTo(12.5623f, 17.0f, 13.01f, 16.5523f, 13.01f, 16.0f)
        curveTo(13.01f, 15.4477f, 12.5623f, 15.0f, 12.01f, 15.0f)
        lineTo(12.0f, 15.0f)
        close()
    }
    path(
        ...
        // Subpath 2 (hole)
        moveTo(12.0f, 3.0f)
        curveTo(7.02944f, 3.0f, 3.0f, 7.02944f, 3.0f, 12.0f)
...
@Preview
@Composable
private fun MediumRegularOutlineAlertCircleImageVectorPreview() {
    Icon(
        createMediumRegularOutlineAlertCircleImageVector(),
        contentDescription = "AlertCircle"
    )
}
