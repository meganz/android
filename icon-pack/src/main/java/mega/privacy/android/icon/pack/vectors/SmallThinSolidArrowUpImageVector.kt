...
public fun createSmallThinSolidArrowUpImageVector(): ImageVector = ImageVector.Builder(
    name = "icon_arrow-up_small_thin_solid",
...
@Preview
@Composable
private fun SmallThinSolidArrowUpImageVectorPreview() {
    Icon(
        createSmallThinSolidArrowUpImageVector(),
