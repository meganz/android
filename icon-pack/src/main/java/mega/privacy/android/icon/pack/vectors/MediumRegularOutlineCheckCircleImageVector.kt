...
public fun createMediumRegularOutlineCheckCircleImageVector(): ImageVector = ImageVector.Builder(
    name = "icon_check-circle_medium_regular_outline",
    ...
    path(
        ...
        // Subpath 2 (hole)
        moveTo(3.0f, 12.0f)
        curveTo(3.0f, 7.02944f, 7.02944f, 3.0f, 12.0f, 3.0f)
        curveTo(16.9706f, 3.0f, 21.0f, 7.02944f, 21.0f, 12.0f)
        curveTo(21.0f, 16.9706f, 16.9706f, 21.0f, 12.0f, 21.0f)
        curveTo(7.02944f, 21.0f, 3.0f, 16.9706f, 3.0f, 12.0f)
        close()
    }
}.build()
...
@Preview
@Composable
private fun MediumRegularOutlineCheckCircleImageVectorPreview() {
    Icon(
