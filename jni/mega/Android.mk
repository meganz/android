...
LOCAL_CFLAGS := -fexceptions -frtti -fvisibility=hidden -fvisibility-inlines-hidden -fdata-sections -ffunction-sections -DUSE_PTHREAD -DUSE_EXTERNAL_GFX
...
include $(LOCAL_PATH)/Makefile.inc
LOCAL_MODULE    := mega
LOCAL_CFLAGS := -fexceptions -frtti -fdata-sections -ffunction-sections -DUSE_PTHREAD -DUSE_EXTERNAL_GFX
