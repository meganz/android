...
internal class CallIsSystemInDarkThemeDetector : Detector(), Detector.UastScanner {
    ...
    """,
            ...
            Implementation(CallIsSystemInDarkThemeDetector::class.java, Scope.JAVA_FILE_SCOPE)
        )
    }
}