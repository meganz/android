...
import mega.privacy.android.shared.original.core.ui.theme.blue_200
import mega.privacy.android.shared.original.core.ui.theme.blue_300
import mega.privacy.android.shared.original.core.ui.theme.blue_400
import mega.privacy.android.shared.original.core.ui.theme.blue_700
import mega.privacy.android.shared.original.core.ui.theme.colorButtonBrandhDark
import mega.privacy.android.shared.original.core.ui.theme.colorButtonBrandhLight
...
import mega.privacy.android.shared.original.core.ui.theme.dark_blue_tooltip
import mega.privacy.android.shared.original.core.ui.theme.dark_grey
import mega.privacy.android.shared.original.core.ui.theme.green_300
...
import mega.privacy.android.shared.original.core.ui.theme.grey_050
import mega.privacy.android.shared.original.core.ui.theme.grey_100
import mega.privacy.android.shared.original.core.ui.theme.grey_100_alpha_060
...
import mega.privacy.android.shared.original.core.ui.theme.lightBlack
import mega.privacy.android.shared.original.core.ui.theme.lightGrey
...
import mega.privacy.android.shared.original.core.ui.theme.orange_600
...
import mega.privacy.android.shared.original.core.ui.theme.white_alpha_050
...
/**
 * Color [white_alpha_070] when light and [grey_alpha_070] when dark
 */
val Colors.white_alpha_070_grey_alpha_070: Color
    get() = if (isLight) white_alpha_070 else grey_alpha_070
...
/**
 * Color when light [yellow_100] and when dark [yellow_700]
 */
val Colors.yellow_100_yellow_700: Color
    get() = if (isLight) yellow_100 else yellow_700
...
/**
 * Color background when light else [white_alpha_005]
 */
val Colors.background_white_alpha_005: Color
    get() = if (isLight) background else white_alpha_005

/**
 * Color [grey_300] when light and [white_alpha_087] when dark
 */
val Colors.grey_300_white_alpha_087: Color
    get() = if (isLight) grey_300 else white_alpha_087

/**
 * Color [lightGrey] when light and [lightBlack] when dark
 */
val Colors.light_grey_light_black: Color
    get() = if (isLight) lightGrey else lightBlack

/**
 * Color [grey_100] when light and [grey_600] when dark
 */
val Colors.grey_100_grey_600: Color
    get() = if (isLight) grey_100 else grey_600

/**
 * Color [blue_700] when light and [blue_200] when dark
 */
val Colors.blue_700_blue_200: Color
