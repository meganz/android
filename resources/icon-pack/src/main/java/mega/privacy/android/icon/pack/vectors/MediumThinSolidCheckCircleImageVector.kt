...
public fun createMediumThinSolidCheckCircleImageVector(): ImageVector = ImageVector.Builder(
    name = "icon_check-circle_medium_thin_solid",
...
@Preview
@Composable
private fun MediumThinSolidCheckCircleImageVectorPreview() {
    Icon(
