...
/**
 * Navigation key for SaveScannedDocumentsActivity that handles legacy navigation. It will be removed once FileExplorer activity has been refactored to compose navigation.
 *
 ...
 */
@Serializable
data class SaveScannedDocumentsActivityNavKey(
...
/**
 * Navigation key for SaveScannedDocumentsActivity
 *
 * @param originatedFromChat True if the scan originated from chat
 * @param cloudDriveParentHandle The parent handle used when saving to Cloud Drive
 * @param scanPdfUri String representation of the PDF Uri generated by the scanner
