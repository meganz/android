...
class RemoveRecentlyWatchedVideoBottomSheetItemTest {
    ...
    fun `test shouldDisplay returns correctly`(
        ...
        val removeRecentlyWatchedVideoMenuItem =
            RemoveRecentlyWatchedVideoBottomSheetItem(mock<RemoveRecentlyWatchedVideoMenuAction>())

        val result = removeRecentlyWatchedVideoMenuItem.shouldDisplay(
