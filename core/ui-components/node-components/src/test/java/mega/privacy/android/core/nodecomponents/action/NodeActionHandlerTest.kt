...
class NodeActionHandlerTest {
    ...
    @Test
    fun `test mocked SelectAllMenuAction can be created`() {
        val mockAction = mock<SelectAllMenuAction>()
        assertThat(mockAction).isNotNull()
    }

    @Test
    fun `test mocked ClearSelectionMenuAction can be created`() {
        val mockAction = mock<ClearSelectionMenuAction>()
        assertThat(mockAction).isNotNull()
    }
    ...
    fun `test ViewModel multiple nodes action handling with different action types`() {
        ...
        val actions = listOf(
            ...
            mock<SelectAllMenuAction>(),
            mock<ClearSelectionMenuAction>()
        )
