...
ifneq ($(DISABLE_WEBRTC),true)
  ...
  LOCAL_EXPORT_CFLAGS := -DCHATLIB_ONLOAD -DNDEBUG -DANDROID -DWEBRTC_POSIX -DWEBRTC_LINUX -DWEBRTC_ANDROID -DWEBRTC_INCLUDE_INTERNAL_AUDIO_DEVICE -DRTC_ENABLE_VP9 -DWEBRTC_HAVE_SCTP -DWEBRTC_LIBRARY_IMPL -DABSL_ALLOCATOR_NOTHROW=1 -DLIBYUV_DISABLE_SME -DLIBYUV_DISABLE_LSX -DLIBYUV_DISABLE_LASX
